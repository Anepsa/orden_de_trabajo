    ...
    render() {
      ...
      <Col >
        ...
        <Col md={3}>
                 ...
                 <Col >
                     <Input type="select"  className="obligatorio" name="area" value={area} onChange={handleChange}>
            ...
            <Input  type="select" name="holding" value={holding} readOnly>
              ...
              <Col>
                <Input  type="select" name="servicios" value={servicios} onChange={handleChange}>
                <option value="">Selecciona</option>
                    ...
                    <option value="AVALÚO DE MAQUINARIA">AVALÚO DE MAQUINARIA</option>
